...
if(isset($_POST['adminLogin'])){
    if($_POST['email'] == '' || $_POST['password'] == ''){
        $errorMessage = '<div class="alert alert-danger text-center text-light"><b>Email id and password are required!</b></div>';
    }
    else{
        require_once('Class/Admin.php');
        $userObject = new Admin();
        $userLog = $userObject->adminLogin($_POST);
        if($userLog == true){
            header('location: dashboard.php');
        }
        else{
            $errorMessage = '<div class="alert alert-danger text-center text-light"><b>Wrong credential!</b></div>';
        }
    }
}
                 ...
                 <?php echo $errorMessage; ?>
                  <form role="form" action="" method="post" name="myForm">
                    ...
                    <div class="text-center">
                      <button type="submit" name="adminLogin" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign in</button>
                    </div>
                  </form>
                </div>
